...
bot_token = '7256495827:AAFOE5YTeyqnIhUKYJMUbWIiH6jOs0u2D8U'  # Replace with your bot token
...
ADMIN_ID = 5320823214  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @VIPxMODS: {ADMIN_ID}")
